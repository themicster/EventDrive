...
namespace ConsoleSample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            RandomNumberGeneratorEvent rnge = new RandomNumberGeneratorEvent(mb);
            rnge.Publish();

            //mb.Subscribe("GetCustomerNameQuery", GetCustomerNameQuery.OnGetCustomerNameQuery);
            mb.Subscribe("GetCustomerNameResponse", GetCustomerNameResponse.OnGetCustomerNameResponse);

            GetCustomerNameQuery gcnq = new GetCustomerNameQuery();
            mb.Publish("GetCustomerNameQuery", gcnq, gcnq);

            //mb.Publish("RandomNumberGeneratorRequest", "Main", new RandomNumberGeneratorRequest());
